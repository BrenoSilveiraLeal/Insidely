...
export function SiteFooter() {
  return <footer className="footer"><div className="container">
    <div className="footer-grid">
      ...
      <div><h4>Insidely</h4><div className="footer-links"><Link href="/sobre">Sobre a ideia</Link><Link href="/suporte">Falar com o suporte</Link><span>Privacidade por padrão</span><span>Perfis verificados</span></div></div>
    </div>
