...
function stateLabel(status: string) { return ({ PENDING_PAYMENT: "Solicitação recebida · aguardando pagamento", CONFIRMED: "Confirmada · valor retido", AWAITING_CONFIRMATION: "Aguardando confirmação", COMPLETED: "Concluída · repasse liberado", DISPUTED: "Em análise pelo suporte" } as Record<string, string>)[status] ?? status; }
