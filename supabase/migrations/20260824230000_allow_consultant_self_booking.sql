-- A consultant can also act as a customer when testing or booking their own profile.
-- Keep the authorization tied to the authenticated application's User row.
